...
def voice_assistant(data):
    ...
    if "email" in data:
        ...
        to = listen()
        edict = {'shy':'theshyone@gmail.com','shreya':'arorashreya1200@gmail.com'}
        toaddr = edict[to]
...
time.sleep(2)
respond("Hey Shreya,what can I do for you?")
listening = True
while listening == True:
    data = listen() #calling the listen() here
